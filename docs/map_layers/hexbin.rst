...
.. automodule:: visigoth.map_layers.hexbin

.. autoclass:: visigoth.map_layers.hexbin.Hexbin
...
Source Code `(Link to Github) <https://github.com/visualtopology/visigoth/blob/master/docs/src/map_layers/hexbin/example.py>`_:
