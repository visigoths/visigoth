...
.. automodule:: visigoth.map_layers.wms

.. autoclass:: visigoth.map_layers.wms.WMS
...
Source Code `(Link to Github) <https://github.com/visualtopology/visigoth/blob/master/docs/src/map_layers/wms/example.py>`_:
