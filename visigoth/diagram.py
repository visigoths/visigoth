...
class Diagram:
    ...
    def generateFooter(self):
        return Text(
            [Span("Generated by: "),
             Span(" visigoth v"+visigoth.version, url="http://visigoth.org"),
             Span(" ( "),
             Span(" source code", url="https://github.com/visigoths/visigoth"),
             Span(" ) ")],font_height=14)
    ...
    def draw(self,format="svg",html_title=""):
        """
        ...
        """
        doc = self.createDoc(format,html_title=html_title)
        return doc.render()

    def createDoc(self,format,html_title=""):
        """
        Draw the diagram to create an SVG document
